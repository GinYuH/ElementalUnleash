...
namespace Bluemagic.Items.Purium.Weapons.Projectiles
{
    public class PuriumStaff : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.RainbowTorch, 0f, 0f, 100, Bluemagic.PureColor, 2.5f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int k = 0; k < 20; k++)
            {
                int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.RainbowTorch, 0f, 0f, 100, Bluemagic.PureColor, 2f);
                Main.dust[dust].noGravity = true;
